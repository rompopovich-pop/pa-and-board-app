...
- **Multi-board owners**: can one account run boards for more than one business, or is it one board per account for v1? Now also a pricing question — the draft free tier allows one board (`payments-spec.md` section 3).
